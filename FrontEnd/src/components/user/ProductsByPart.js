...
class ProductsByPart extends Component {
    state = {
        products: [],
        productSearch: [],
        part:[]
    ...
    componentDidUpdate(prevProps) {
        console.log(this.props.match.params.part)
        if (this.props.match.params.part !== prevProps.match.params.part) {
            axios.get(`/products/${this.props.match.params.part}`)
            .then(res => {
                this.setState({products: res.data, productSearch: res.data})
            })
            this.getPart()
        ...
        <div className='container'>
            <nav className='navbar navbar-expand-lg' style={{backgroundColor:'#f5f5f5'}}>
                ...
                <li className='nav-item'>
                        ...
                        <span className='ml-1 align-content-center'>Tampilkan Semua Produk
                        </span>
                        </Link>
                </li>
                </div>
